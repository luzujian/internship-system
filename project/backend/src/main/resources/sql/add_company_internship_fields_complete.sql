...
-- 添加公司标签字段（系统自动标识：双向选择阶段/学生自主联系/接受兜底）
ALTER TABLE company_users ADD COLUMN company_tag VARCHAR(50) COMMENT '公司标签：双向选择阶段/学生自主联系/接受兜底' AFTER max_backup_students;
