...
public class RecruitmentController {
    ...
    public Result getRecruitmentPositions(
        ...
        log.info("分页查询招聘岗位列表，页码: {}, 每页: {}, 公司: {}, 岗位: {}", page, pageSize, companyName, positionName);
    ...
    public Result getRecruitmentApplications(
            ...
            @RequestParam(required = false) String companyName) {
        log.info("分页查询应聘申请列表，页码: {}, 每页: {}, 学生ID: {}, 学生姓名: {}, 性别: {}, 公司ID: {}, 公司名称: {}",
        ...
        PageResult<StudentInternshipStatus> pageResult = studentInternshipStatusService.findPage(
                page, pageSize, studentId, name, gender, null, companyId, companyName);
    ...
    public Result getRecruitmentStatistics() {
        ...
        List<StudentInternshipStatus> applicationStudents = studentInternshipStatusService.list(null, null, null, 0, null, null);
        List<StudentInternshipStatus> offerStudents = studentInternshipStatusService.list(null, null, null, 1, null, null);
        List<StudentInternshipStatus> confirmedStudents = studentInternshipStatusService.list(null, null, null, 2, null, null);
    ...
    public Result getPositionApplications(@PathVariable Long id) {
        ...
        List<StudentInternshipStatus> applications = studentInternshipStatusService.list(null, null, null, null, null, null);
    ...
    public Result getCompanyPositions(@PathVariable Long companyId) {
        log.info("获取公司岗位列表，公司ID: {}", companyId);
