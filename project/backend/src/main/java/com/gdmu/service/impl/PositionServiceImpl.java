...
public class PositionServiceImpl implements PositionService {
    ...
    public List<Position> findByCompanyId(Long companyId) {
        log.debug("根据公司ID查询岗位信息，公司ID: {}", companyId);
    ...
    @Override
    public List<Position> findByCompanyIdWithFilters(Long companyId, String positionName, String department, String status) {
        log.debug("根据公司ID查询岗位信息（支持筛选），公司ID: {}, 岗位名称: {}, 部门: {}, 状态: {}", 
        ...
        return positionMapper.findByCompanyIdWithFilters(companyId, positionName, department, status);
    }
    
    @Override
    public List<Position> list(Long companyId, String positionName) {
        log.debug("动态条件查询岗位信息，公司ID: {}, 岗位名称: {}", companyId, positionName);
    ...
    public PageResult<Position> findPage(Integer page, Integer pageSize, Long companyId, String positionName) {
        log.debug("分页查询岗位信息，页码: {}, 每页大小: {}, 公司ID: {}, 岗位名称: {}", 
    ...
    public PageResult<Map<String, Object>> findPage(Integer page, Integer pageSize, String companyName, String positionName) {
        log.debug("分页查询岗位信息（带公司名称），页码: {}, 每页大小: {}, 公司名称: {}, 岗位名称: {}",
    ...
    public PageResult<Position> findPageByCompanyId(Long companyId, Integer page, Integer pageSize) {
        log.debug("根据公司ID分页查询岗位，公司ID: {}, 页码: {}, 每页大小: {}", companyId, page, pageSize);
    ...
    public Long countByCompanyId(Long companyId) {
        log.debug("根据公司ID统计岗位数量，公司ID: {}", companyId);
    ...
    public int pausePosition(Long positionId) {
        log.debug("暂停岗位，岗位ID: {}", positionId);
        ...
        int result = positionMapper.update(position);
        log.info("岗位暂停成功，岗位ID: {}, 岗位名称: {}", positionId, position.getPositionName());
        return result;
    }
    ...
    public int resumePosition(Long positionId) {
        log.debug("恢复岗位，岗位ID: {}", positionId);
        ...
        int result = positionMapper.update(position);
        log.info("岗位恢复成功，岗位ID: {}, 岗位名称: {}", positionId, position.getPositionName());
        return result;
    }
}