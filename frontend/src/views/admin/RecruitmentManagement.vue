    ...
    >
      <div v-if="currentApplication" class="detail-content">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="专业">{{ currentApplication.major || '暂无' }}</el-descriptions-item>
          <el-descriptions-item label="联系电话">{{ currentApplication.phone || '暂无' }}</el-descriptions-item>
          <el-descriptions-item label="电子邮箱">{{ currentApplication.email || '暂无' }}</el-descriptions-item>
