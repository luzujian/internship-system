  ...
  <div class="problem-feedback-container">
    ...
    <el-card class="actions-card" shadow="never">
      <div class="actions-container">
        ...
        <div class="secondary-actions">
          <el-button v-if="authStore.hasPermission('problem:view')" type="success" @click="handleExportToExcel" class="action-btn success">
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="userAccount" label="用户账号" width="200" align="center"></el-table-column>
        ...
        <el-table-column prop="feedbackType" label="反馈类型" width="200" align="center">
          <template #default="scope">
...
const handleExportToExcel = async (): Promise<void> => {
  try {
    ...
    const blob = await problemFeedbackApi.exportFeedbackData()
    const url = window.URL.createObjectURL(blob as unknown as Blob)
    const link = document.createElement('a')
    link.href = url
    link.download = `问题反馈导出_${new Date().getTime()}.xlsx`
