...
public class StudentUserController {
    ...
    public Result getAllStudentUsers(@RequestParam(defaultValue = "1") Integer page,
        ...
        log.info("分页获取学生用户列表，页码: {}, 每页条数: {}, 学号: {}, 姓名: {}, 年级: {}, 专业ID: {}, 班级ID: {}, 状态: {}, 性别: {}",
                page, pageSize, studentId, name, grade, majorId, classId, status, gender);
        PageResult<StudentUser> pageResult = studentUserService.findPage(page, pageSize, studentId, name, grade, majorId, classId, status, gender);
