...
public class AdminController {
     ...
     */
    @Autowired
    private com.gdmu.mapper.ProblemFeedbackMapper problemFeedbackMapper;
    ...
    public Result getRecentFeedback() {
        log.info("获取最近的问题反馈");
        try {
            List<com.gdmu.entity.ProblemFeedback> feedbackList = problemFeedbackMapper.findRecent(5);
