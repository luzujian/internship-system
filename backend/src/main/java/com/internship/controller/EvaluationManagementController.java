...
public class EvaluationManagementController {
    ...
    public Result getStudentList(
        ...
        if (currentUserId != null) {
            List<com.internship.entity.Class> counselorClasses = classCounselorRelationService.findClassesByCounselorId(currentUserId);
            if (counselorClasses != null && !counselorClasses.isEmpty()) {
                counselorClassIds = counselorClasses.stream()
                        .map(com.internship.entity.Class::getId)
        ...
        if (currentUserId != null) {
            ...
            if (teacher != null && "COUNSELOR".equals(teacher.getTeacherType())) {
                ...
                counselorClassIdSet = counselorClasses.stream()
                    .map(com.internship.entity.Class::getId).collect(Collectors.toSet());
            }
        }
    ...
    private String getClassName(Long classId) {
        ...
        try {
            com.internship.entity.Class clazz = classService.findById(classId);
            if (clazz != null) {
    ...
    private String getMajorName(Long majorId) {
        ...
        try {
            com.internship.entity.Major major = majorService.findById(majorId);
            if (major != null) {
    ...
    private String getDepartmentByMajorId(Long majorId) {
        ...
        try {
            ...
            if (major != null && major.getDepartmentId() != null) {
                com.internship.entity.Department department = departmentService.findById(major.getDepartmentId());
                if (department != null) {
