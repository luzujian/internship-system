...
public class CategoryWeightController {
    ...
    @PostMapping
    @Log(operationType = "INSERT", module = "SCORING_RULE_MANAGEMENT", description = "新增类别权重")
    ...
    @PutMapping("/{id}")
    @Log(operationType = "UPDATE", module = "SCORING_RULE_MANAGEMENT", description = "更新类别权重")
    ...
    @DeleteMapping("/{id}")
    @Log(operationType = "DELETE", module = "SCORING_RULE_MANAGEMENT", description = "删除类别权重")
    ...
    @Log(operationType = "DELETE", module = "SCORING_RULE_MANAGEMENT", description = "根据类别代码删除权重")
    ...
    @PostMapping("/batch")
    @Log(operationType = "UPDATE", module = "SCORING_RULE_MANAGEMENT", description = "批量更新类别权重")
