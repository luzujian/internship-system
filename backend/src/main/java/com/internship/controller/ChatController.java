...
import com.internship.entity.Chat;
import com.internship.entity.ChatMessage;
import com.internship.entity.ChatMember;
import com.internship.entity.Result;
import com.internship.service.ChatService;
import com.internship.service.ChatMessageService;
...
public class ChatController {
     ...
     */
    @PostMapping("/group")
    @Log(operationType = "INSERT", module = "CHAT_MANAGEMENT", description = "创建群聊")
     ...
     */
    @PostMapping("/single")
    @Log(operationType = "INSERT", module = "CHAT_MANAGEMENT", description = "创建单聊会话")
     ...
     */
    @PostMapping("/message")
    @Log(operationType = "INSERT", module = "CHAT_MANAGEMENT", description = "发送消息")
    ...
    @Log(operationType = "INSERT", module = "CHAT_MANAGEMENT", description = "添加群聊成员")
