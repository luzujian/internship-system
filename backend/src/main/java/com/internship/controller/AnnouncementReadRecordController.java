...
public class AnnouncementReadRecordController {
    ...
    public Result getUnreadCount(@PathVariable Long announcementId,
        ...
        log.info("获取公告未读人数，公告ID: {}, 目标类型: {}", announcementId, targetType);
        try {
            Long count = announcementReadRecordService.countUnreadByAnnouncementId(announcementId, targetType, targetValue);
